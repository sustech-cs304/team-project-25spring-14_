  ...
  <div class="main-container">
    ...
    <div class="content-wrapper">
      <div class="album-header">
        ...
        <el-button type="primary" @click="showFilter = true" style="margin-left: 16px;">
            筛选
        </el-button>
        <el-dialog v-model="showFilter" title="筛选照片" width="400px">
            <el-form :model="filterForm" label-width="80px">
                <el-form-item label="标签">
                    <el-input v-model="filterForm.tag" placeholder="输入标签"></el-input>
                </el-form-item>
                <el-form-item label="地点">
                    <el-input v-model="filterForm.location" placeholder="输入地点"></el-input>
                </el-form-item>
                <el-form-item label="收藏">
                    <el-switch v-model="filterForm.isFavorite" active-text="是" inactive-text="否"></el-switch>
                </el-form-item>
            </el-form>
            <template #footer>
