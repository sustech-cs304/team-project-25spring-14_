      ...
      for (const photo of this.photos) {
        if (
          (this.filterCriteria.startDate &&
            new Date(photo.uploadTime) < new Date(this.filterCriteria.startDate)) ||
          (this.filterCriteria.endDate &&
            new Date(photo.uploadTime) > new Date(this.filterCriteria.endDate)) ||
          (this.filterCriteria.tag && !photo.tag.includes(this.filterCriteria.tag)) ||
