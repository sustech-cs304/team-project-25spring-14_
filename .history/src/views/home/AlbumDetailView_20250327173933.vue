        ...
        <div class="album-info-wrapper">
          <div class="album-title-row">
            ...
            <div
              ...
              @keydown.enter.prevent="updateAlbumTitl e"
            ...
            <div class="privacy-select">
              <div v-if="!editingPrivacy" @click="editingPrivacy = true">
                <img
                  :src="`@/assets/images/${editablePrivacy}.svg`"
                  :alt="editablePrivacy"
                  class="privacy-icon"
                />
              </div>
