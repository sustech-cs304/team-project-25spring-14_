  ...
  >
    <div class="photo-viewer-container">
      ...
      >
        ...
        <div
          v-if="Object.keys(finalSubtitleObject).length > 0"
          style="border-top: 1px solid #eee; margin: 10px 20px 0; padding-top: 10px"
        >
          <h4>当前字幕预览：</h4>
          <ul>
            <li v-for="(text, time) in finalSubtitleObject" :key="time">
...
export default {
  ...
  methods: {
    ...
    submitVideoEdit() {
      ...
      this.finalSubtitleObject = result;
      this.videoEditDialogVisible = false;
      this.$message.success("已确认字幕内容");
    },
