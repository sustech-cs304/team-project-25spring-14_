...
export default {
  ...
  methods: {
    ...
    getPrivacyIcon(privacy) {
      switch (privacy) {
        case 'PUBLIC':
          return require('@/assets/images/PUBLIC.svg');
        case 'PRIVATE':
          return require('@/assets/images/PRIVATE.svg');
        case 'SHARED':
          return require('@/assets/images/SHARED.svg');
        default:
          return '';
      }
    },
...
.privacy-dropdown .el-input__inner {
  padding: 0;
  text-indent: -9999px;
}

.privacy-dropdown .el-input__suffix {
  display: none;
}
