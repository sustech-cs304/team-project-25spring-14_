<template>
  ...
  >
    <div class="photo-viewer-container">
      ...
      <el-dialog v-model="videoEditDialogVisible" title="视频编辑设置" width="400px">
        <el-form :model="videoEditOptions" label-width="80px">
          <el-form-item label="字体">
            <el-input v-model="videoEditOptions.font_name"></el-input>
          </el-form-item>
          <el-form-item label="字号">
            <el-input v-model="videoEditOptions.font_size" type="number"></el-input>
          </el-form-item>
          <el-form-item label="字体颜色">
            <el-input v-model="videoEditOptions.font_color"></el-input>
          </el-form-item>
        </el-form>
        <template #footer>
      ...
      <div class="photo-actions">
        <el-button
          type="primary"
          @click="isVideo(photo.fileUrl) ? openVideoEditDialog() : $emit('edit', photo)"
        >
          编辑
        </el-button>
