<template>
  ...
  >
    <div class="photo-viewer-container">
      <!-- 图片信息区 -->
<div class="photo-info" style="display: flex; align-items: center; justify-content: space-between;">
  <div>
  ...
  <el-button type="success" @click="editDialogVisible = true">信息编辑</el-button>
</div>
