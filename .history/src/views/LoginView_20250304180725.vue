    ...
    <div class="main">
      <div :class="['block', 'block_register', { 'is-txl': isLogin }]">
        <form @submit.prevent="register">
          ...
          <input class="form_input" type="text" placeholder="Name" v-model="registerForm.name" />
          <input class="form_input" type="text" placeholder="Email" v-model="registerForm.email" />
