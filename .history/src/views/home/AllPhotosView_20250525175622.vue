<template>
  <div class="main-container">
    ...
    >
<video
  v-if="showVideo && VideoByte"
  controls
  autoplay
  playsinline
  muted
  style="width: 100%; max-height: 500px; background-color: black; display: block !important; visibility: visible; opacity: 1;"
  :src="`data:video/mp4;base64,${VideoByte}`"
  @loadeddata="() => console.log('视频已加载')"
  @error="(e) => console.error('视频加载出错', e)"
></video>
      <template #footer>
  ...
  methods: {
    ...
    async submitMemoryRequest() {
      ...
      try {
        ...
        // 先设置 VideoByte，再在 nextTick 后显示视频
