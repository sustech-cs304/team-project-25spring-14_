...
.photo-card {
  background: #f3f4f6;
  /* Ensure cards clip overflow and are positioned for border */
  overflow: hidden;
  position: relative;
  aspect-ratio: 1 / 1;
  display: flex;
  ...
  /* Smooth transition for border color and scale */
...
.photo-card:hover {
  ...
  border-color: #4B70E2;
  /* Slightly scale up the entire card */
