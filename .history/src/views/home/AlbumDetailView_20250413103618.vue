      ...
      <div class="album-header">
        <div class="album-cover-wrapper">
          ...
          <div
            ...
            @click="isSelf ? updateAlbumCover() : null"
          >
  ...
  methods: {
    ...
    async handleCoverChange(event) {
      ...
      try {
        ...
        formData.append("file", file);
        formData.append("albumId", this.album.albumId);
        formData.append("path", this.album.albumId);
        ...
        console.log("封面更新成功：", response.data.data);
        this.album.coverPhotoId = response.data.data.photo.coverPhotoId;
