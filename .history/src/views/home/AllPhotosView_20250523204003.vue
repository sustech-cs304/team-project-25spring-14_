...
export default {
  ...
  methods: {
    ...
    applyFilter() {
      ...
      this.filterPhotos = [];
      if (!this.filterCriteria.startDate && !this.filterCriteria.endDate && !this.filterCriteria.tag && !this.filterCriteria.location && this.filterCriteria.isFavorite === null) {
      ...
      for (const photo of this.photos) {
        if (
          ...
          photo.capturedAt < this.filterCriteria.startDate
        ) {
          continue;
        }
        if (
          this.filterCriteria.endDate &&
          photo.capturedAt > this.filterCriteria.endDate
        ) {
          continue;
        }
        if (
        ...
        if (
          ...
          !photo.location.includes(this.filterCriteria.location)
        ) {
          continue;
        }
        if (
          this.filterCriteria.isFavorite !== null &&
          photo.isFavorite !== this.filterCriteria.isFavorite
        ) {
          continue;
        }
