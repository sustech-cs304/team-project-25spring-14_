  ...
  >
    <div class="photo-viewer-container">
      ...
      >
        ...
        <div
          v-if="showFontStyleForm"
          style="margin: 20px 20px 0; padding-top: 10px; border-top: 1px solid #eee"
        >
          <h4>设置字幕样式</h4>
          <el-form :model="videoEditOptions" label-width="80px">
            <el-form-item label="字体">
              <el-select v-model="videoEditOptions.font_name" placeholder="请选择字体">
            ...
            <el-form-item label="字号">
              <el-input-number v-model="videoEditOptions.font_size" :min="10" :max="100" />
            </el-form-item>
            <el-form-item label="颜色">
              <el-radio-group v-model="videoEditOptions.font_color">
...
export default {
  ...
  methods: {
    ...
    submitVideoEdit() {
      ...
      this.$message.success("已确认字幕内容，请选择样式");
    },
