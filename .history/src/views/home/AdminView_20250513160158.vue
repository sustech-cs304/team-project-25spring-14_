      ...
      <div class="content-area">
        ...
        <div v-if="currentTab === 'reports'">
          ...
          <div class="report-list">
            <div class="report-item" v-for="report in filteredReports" :key="report.reportId">
              举报ID：{{ report.reportId }}，举报人ID：{{ report.reporterId }}，类型：{{ report.resourceType }}，资源ID：{{ report.resourceId }}，理由：{{ report.reason }}，时间：{{ report.createdAt }}
            </div>
