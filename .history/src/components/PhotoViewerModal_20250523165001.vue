  ...
  >
    <div class="photo-viewer-container">
      ...
      <div class="photo-info">
        ...
        <el-button type="success" @click="editInfoVisible = true">修改信息</el-button>
      </div>
      ...
      <el-dialog v-model="editInfoVisible" title="修改照片信息">
        ...
        <template #footer>
          ...
          <el-button type="primary" @click="$emit('editInfo', photo)">保存</el-button>
        </template>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    submitEdits() {
      this.$emit('edit', { ...this.editablePhoto });
