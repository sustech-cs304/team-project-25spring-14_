...
export default {
  ...
  data() {
    return {
      activeNav: "discover",
      navItems: [
        { name: "home", icon: "icon-u138", label: "发现", path: "/home/discover" },
        { name: "photos", icon: "icon-quanbuzhaopian1", label: "全部照片", path: "/home/photos" },
        { name: "albums", icon: "icon-xiangceji", label: "相册集", path: "/home/albums" },
        { name: "share", icon: "icon-gongxiangkongjian", label: "共享空间", path: "/home/share" },
        { name: "recycle", icon: "icon-huishouzhan", label: "回收站", path: "/home/recycle" },
        { name: "settings", icon: "icon-shezhi", label: "设置", path: "/home/settings" },
