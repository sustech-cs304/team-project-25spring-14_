  ...
  <div class="main-container">
    ...
    <div class="content-wrapper">
      ...
      <div class="photo-grid">
        <div
          class="photo-card"
          @mouseover="photo.showHeart = true"
        ...
        >
          ...
          <div
            ...
            :class="{ favorited: photo.favorited }"
          >
            <i :class="photo.favorited ? 'fas fa-heart' : 'far fa-heart'"></i>
          </div>
        </div>
...
export default {
  ...
  async created() {
    ...
    try {
      ...
      this.album.photos.forEach((p) => (p.favorited = false));
    } catch (error) {
...
.photo-card:hover .favorite-icon,
