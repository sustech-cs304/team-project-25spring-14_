  ...
  methods: {
    ...
    async updateAlbumCover(photoId) {
      ...
      try {
        ...
        await apiClient.post(`/albums/${this.album.albumId}/cover/upload`, formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        }).then((response) => {
          const coverPhotoId = response.data.data.coverPhotoId;
          this.album.coverPhotoUrl = newCoverPhoto.thumbnailUrl;
        });
      try {
