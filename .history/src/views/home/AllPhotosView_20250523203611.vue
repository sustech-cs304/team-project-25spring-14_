  ...
  methods: {
    ...
    applyFilter() {
      ...
      for (const photo of this.photos) {
        if (this.filterCriteria.startDate && photo.capturedAt < this.filterCriteria.startDate) {
          continue;
        }
        if (this.filterCriteria.endDate && photo.capturedAt > this.filterCriteria.endDate) {
          continue;
        }
        if (this.filterCriteria.tag && !photo.tag.includes(this.filterCriteria.tag)) {
          continue;
        }
        if (this.filterCriteria.location && !photo.location.includes(this.filterCriteria.location)) {
          continue;
        }
        if (this.filterCriteria.isFavorite !== null && photo.isFavorite !== this.filterCriteria.isFavorite) {
          continue;
        }
      }
    },
