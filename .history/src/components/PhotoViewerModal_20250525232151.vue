  ...
  >
    <div class="photo-viewer-container">
      ...
      <el-dialog
        ...
        width="400px"
      >
        <div v-if="!showSubtitleForm" style="text-align: center; padding: 20px;">
          <el-button type="primary" @click="enableSubtitleEdit">添加字幕</el-button>
        </div>
        <el-form v-else :model="videoEditOptions" label-width="80px">
        ...
        <template #footer>
          ...
          <el-button type="primary" v-if="showSubtitleForm" @click="submitVideoEdit">确认</el-button>
        </template>
      </el-dialog>
