  ...
  >
    <template v-if="!showDetailForm && !showPasswordForm">
      ...
      <div class="button-row">
        <el-button type="primary" plain @click="goToDetail">修改信息</el-button>
        <el-button type="warning" plain @click="goToPassword">修改密码</el-button>
      </div>
    ...
    <template v-else-if="showPasswordForm">
      <div class="detail-form">
        ...
        <div class="confirm-row">
          <el-button @click="cancelEdit">取消</el-button>
          <el-button type="primary" @click="confirmPasswordEdit">确定</el-button>
        </div>
      </div>
    </template>
