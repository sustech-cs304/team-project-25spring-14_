  ...
  methods: {
    ...
    async fetchData() {
      try {
        ...
        for (const photo of photosRes.data.data.photos) {
          if (photo.tags.includes("人物")) this.person++;
          else if (photo.tags.includes("猫")) this.cat++;
          else if (photo.tags.includes("狗")) this.dog++;
          else if (photo.tags.includes("书")) this.book++;
          else if (photo.tags.includes("飞机")) this.airplane++;
        }
      } catch (error) {
