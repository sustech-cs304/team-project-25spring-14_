<template>
  ...
  >
    <div class="photo-viewer-container">
      ...
      >
        <video
          v-if="encodedVideoBase64"
          controls
          autoplay
          style="width: 100%; height: auto"
          :src="`data:video/mp4;base64,${encodedVideoBase64}`"
        ></video>
        <template #footer>
          <el-button
            @click="
          ...
          <el-button type="primary" @click="downloadEncodedVideo">
            保存
          </el-button>
        </template>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    downloadEncodedVideo() {
      if (!this.encodedVideoBase64) return;
      const byteCharacters = atob(this.encodedVideoBase64);
