<template>
  ...
  >
    <template v-if="!showDetailForm"></template>
      <div class="header">
      ...
      <el-button type="primary" plain @click="goToAlbum">进入相册页面</el-button>
      <el-button type="success" plain @click="goToSpace">进入空间页面</el-button>
      </div>
