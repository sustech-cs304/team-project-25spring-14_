...
export default {
  ...
  data() {
    return {
      ...
      userInfo: {},
      showModal: false,
      currentUserId: this.$route.params.albumOwnerId || this.currentUserId,
      albumOwnerId: null,
    };
  },
  methods: {
    ...
    async fetchAlbums() {
      ...
      try {
        await apiClient
          .get(`/albums/user/${this.currentUserId}`, {
    ...
    async initializePage() {
      ...
      // this.albumOwnerId = this.$route.params.albumOwnerId || this.currentUserId;
      console.log("相册拥有者ID:", this.albumOwnerId);
    },
