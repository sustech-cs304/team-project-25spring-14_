        ...
        <div class="album-info-wrapper">
          <div class="album-title-row">
            ...
            <el-input
              ...
              size="small"
              @blur="updateAlbumTitle"
              @keyup.enter.native="updateAlbumTitle"
              class="editable-input"
            />
            <div class="album-privacy-icon">
              <img
              ...
              />
              <img
                v-else-if="album.privacy === 'PRIVATE'"
                src="@/assets/images/PRIVATE.svg"
                alt="Private"
                class="privacy-icon"
              />
              <img
                v-else-if="album.privacy === 'SHARED'"
          ...
          <el-input
            ...
            size="small"
            @blur="updateAlbumDescription"
            @keyup.enter.native="updateAlbumDescription"
            class="editable-input"
          />
