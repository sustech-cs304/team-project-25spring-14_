  ...
  methods: {
    ...
    async handlePhotoChange(event) {
      ...
      try {
        ...
        // Append all files under the same field name (e.g., 'files')
        files.forEach(file => {
        ...
        // Send a single request with multiple files
        ...
        // Assume backend returns an array of uploaded photo objects
        const newPhotos = response.data.data.photos;
        // Add all uploaded photos to album
        this.album.photos.push(...newPhotos);
        this.album.photoCount += newPhotos.length;
