      ...
      try {
        await apiClient
          .get(`/albums/user/${this.userInfo.userId}`, {
            params: { currentUserId: this.albumOwnerId },
          })
          .then((response) => {
      ...
      try {
        for (const album of this.albums) {
          if (album.coverPhotoId) {
            ...
            album.coverThumbnailUrl = response.data.data.photo.thumbnailUrl;
            album.coverPhotoUrl = response.data.data.photo.fileUrl;
            console.log(
              "相册封面获取成功:",
